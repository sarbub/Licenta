<x-form-section submit="updateProfileInformation">
    ...
    <x-slot name="description" class="text-lg">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-label for="account_type" value="{{ __('Account type(unchangable)') }}" />
            <x-input id="account_type" type="text" class="mt-1 block w-full" value="{{ $this->user->account_type }}" readonly />
